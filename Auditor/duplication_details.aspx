<%@ Page Language="C#" AutoEventWireup="true" CodeFile="duplication_details.aspx.cs" Inherits="Auditor_duplication_details" %>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10">
                    <asp:DataList ID="DataList1" runat="server" class="table table-hover table-borderless">
                        <ItemTemplate>
                           <table class="table table-hover table-borderless" style="width:100%" >
                        <tr>
                            <th>
                             
                                <asp:Label ID="Label2" runat="server" Text="Fully duplication from :" Font-Bold="true"></asp:Label>
                            </th>
